...
```bash
source venv/bin/activate && ruff check aifred/DATEI1.py aifred/DATEI2.py
source venv/bin/activate && mypy aifred/DATEI1.py aifred/DATEI2.py --ignore-missing-imports
```
