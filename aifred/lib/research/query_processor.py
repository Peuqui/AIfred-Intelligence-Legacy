...
async def process_query_and_search(
    ...
    # ============================================================
        ...
        # Query Optimization - always use pre-generated queries from research_decision
        if not pre_generated_queries:
            # This should NEVER happen - research_decision always provides queries
            error_msg = "No pre-generated queries provided by research_decision"
            log_message(f"❌ {error_msg}")
            yield {"type": "error", "message": error_msg}
            raise ValueError(error_msg)

        log_message("⚡ Using pre-generated queries from research_decision")
        yield {"type": "debug", "message": "⚡ Using queries from research_decision"}
    ...
    # ============================================================
        ...
        # Check if pre-generated queries are available (from research_decision)
        if pre_generated_queries:
            # Use pre-generated queries - skip LLM call
            log_message("⚡ Using pre-generated queries from research_decision")
            yield {"type": "debug", "message": "⚡ Using pre-generated queries (skip Query-Opt LLM)"}
            optimized_queries = pre_generated_queries
            query_reasoning = "Pre-generated by research_decision"
            query_opt_time = 0.0
        else:
            # Fallback: Run Query-Optimization LLM call
            ...
            # Show query optimization completion
