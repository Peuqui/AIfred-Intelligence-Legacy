...
class TranslationManager:
    ...
    _translations: Dict[str, Dict[str, str]] = {
        "de": {
            ...
            "agent_editor_cloud_model_hint": "Dieser System-Agent steuert die GPU-Calibration. Er wird nicht im Chat verwendet — der Calibration-Workflow ruft ihn auf, wenn du im Backend-Bereich 🤖 KI als Calibration-Modus wählst. Das Modell entscheidet auf Basis von VRAM-Messungen iterativ über die optimale Kontext- und Tensor-Split-Konfiguration. Qwen-Plus reicht in der Regel; Qwen-Max ist deutlich teurer, aber konsequenter im Reasoning. Der Prompt unten ist nur in Englisch hinterlegt, weil Tool-Use bei Cloud-LLMs auf Englisch zuverlässiger funktioniert.",
        ...
        "en": {
            ...
            "agent_editor_cloud_model_hint": "This system agent drives GPU calibration. It is not used in the chat — the calibration workflow invokes it when you select 🤖 AI as calibration mode in the Backend section. Based on VRAM measurements, the model iteratively decides on the optimal context and tensor-split configuration. Qwen-Plus is usually enough; Qwen-Max is much more expensive but more consistent at reasoning. The prompt below is only stored in English because tool-use works more reliably on English with Cloud LLMs.",
