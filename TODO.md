...
### Naechste Schritte
- [ ] Wake Word Detection (TFLite Mel-Parameter matchen, Custom "Hallo Alfred" trainieren)
- [ ] WebSocket-Client zum AIfred-Server (Audio streamen, TTS empfangen)
- [ ] PuckChannel Plugin in AIfred (WebSocket-Server, STT, TTS-Routing)
- [ ] Sprachsteuerung: Agenten wechseln, Modi umschalten, TTS ein/aus per Voice
- [ ] Verschiedene Wake Words fuer verschiedene Agenten (Hallo Alfred, Hallo Sokrates etc.)
